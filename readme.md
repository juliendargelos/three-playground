...
Playground.play({
  ...
  width: 1024, // Width of the canvas (ignored if autosize or fullscreen are set to true)
  height: 512, // Height of the canvas (ignored if autosize or fullscreen are set to true)
